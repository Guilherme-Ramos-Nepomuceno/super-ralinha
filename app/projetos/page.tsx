  ...
  return (
    <main className="mt-20">
      ...
      <div className="size-full flex flex-col items-center gap-y-3 pt-20 pb-20">
        ...
        <h5 className="w-3/4 font-sans font-bold">
          Futevôlei; Vôlei de Praia; Basquete; Beach Wrestling; Wrestling;
          Jiu-Jitsu;
        </h5>
      </div>
      <div className="size-3/4 lg:size-1/4 m-auto mb-24 flex flex-col items-center p-5 shadow-md">
        ...
        <a href="https://maps.app.goo.gl/94qoVUVWcpd7cRDS6">
          ...
          <h5 id="ultimocamp" className="font-sans">
            Mini Estádio do Planalto Britão
          </h5>
        </a>
      </div>
      <div>
        <a
          className="size-18 p-3 hover:bg-yellow-400 opacity-70 fixed rounded end-2 bottom-4 z-10 transition-colors duration-200 hover:text-green-900 bg-green-600 text-yellow-400"
      ...
      <div className="size-full text-center mb-40">
        <h1 className="text-5xl mt-14 font-bold text-amber-900">
          video do ultimo campeonato
        </h1>
        <h5 className="font-sans text-gray-900">Assista já no youtube</h5>
        <iframe
          className="w-11/12 h-80 mx-auto my-3 lg:w-5/12"
      ...
      <div id="jornada" className="size-full text-center">
        ...
        <div className=" w-full items-center size-full flex flex-col md:flex-row justify-between">
          ...
          <img
            className="w-10 md:hidden lg:flex justify-center"
        ...
        <div className="grid mx-auto my-10 w-3/5 h-20 lg:w-1/5 hover:bg-yellow-400 rounded transition-colors duration-200 hover:text-green-900 bg-green-600 text-yellow-400">
          <a className="h-full" href="https://app.sermaissaudavel.com">
            <h1 className="text-2xl my-6">vá para a inscrição</h1>
          </a>
        </div>
      </div>
      <div id="sobremandu" className="w-full ">
        <h1 className="text-5xl font-bold text-amber-900 p-10 text-center">
          sobre o manduvi
        </h1>
      ...
      <div className="size-full">
        <div className="w-4/5 flex flex-wrap mx-auto my-14 p-3 shadow-2xl lg:w-3/5">
          ...
          <img
            className="m-auto w-2/12"
            src="imagens/patrocinio5.webp"
            alt=""
          />
          <img
            className="m-auto w-2/12"
            src="imagens/patrocinio6.webp"
            alt=""
          />
        </div>
        ...
        <div className="mx-auto mt-2 text-center content-between">
          <h1 className="text-sm mt-2 mb-3 font-bold text-black">
            Todos os direitos reservados
          </h1>
          <a
            className="p-1 font-bold border-solid border-2 border-amber-950 rounded"
