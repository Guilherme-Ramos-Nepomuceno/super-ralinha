...
export default function Projetos(){
    return (
        ...
        <div className="size-full flex flex-col items-center pt-4 gap-y-2">
            ...
            <h5 className="w-3/4 font-sans">O Festival "Ser + Esporte e Lazer", conduzido pelo Instituto Manduvi, promove a inclusão social e o desenvolvimento humano em Cuiabá e Várzea Grande, Mato Grosso, por meio de diversas atividades esportivas e de lazer. Entre as modalidades oferecidas estão:</h5>
